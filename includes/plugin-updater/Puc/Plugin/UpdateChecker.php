...
if ( !class_exists('Lkn_Puc_Plugin_UpdateChecker', false) ):
	...
	class Lkn_Puc_Plugin_UpdateChecker extends Lkn_Puc_UpdateChecker {
	    ...
	    protected function installHooks() {
	        ...
	        //Add Link-n-license header for v3 API download requests
	        add_filter('http_request_args', [$this, 'addLinkNLicenseHeader'], 10, 2);
	    ...
	    public function removeHooks() {
	        ...
	        remove_filter('http_request_args', [$this, 'addLinkNLicenseHeader'], 10);
	    }
	    ...
	    /**
	     * Add Link-n-license header for v3 API requests
	     *
	     * @param array $args HTTP request arguments
	     * @param string $url The request URL
	     * @return array Modified arguments
	     */
	    public function addLinkNLicenseHeader($args, $url) {
	        // Check if this is a request to a v3 API endpoint related to this plugin
	        if (strpos($url, '/v3/') !== false && strpos($url, $this->slug) !== false) {
	            if (!isset($args['headers'])) {
	                $args['headers'] = [];
	            }
	            $args['headers']['Link-n-license'] = base64_decode('OWYwODJmZDgtYkY4MS00YjE1LTllNTAtZGEwNDYzM2I=');
	        }
	        return $args;
	    }
	}
