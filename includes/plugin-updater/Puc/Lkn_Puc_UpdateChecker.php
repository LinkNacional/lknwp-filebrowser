...
namespace Includes\PluginUpdater\Puc;

use WP_Error;
use stdClass;
use Includes\PluginUpdater\Puc\Lkn_Puc_InstalledPackage;
use Includes\PluginUpdater\Puc\Lkn_Puc_Scheduler;
use Includes\PluginUpdater\Puc\Lkn_Puc_UpgraderStatus;
use Includes\PluginUpdater\Puc\Lkn_Puc_StateStore;
...
abstract class Lkn_Puc_UpdateChecker {
    ...
    protected function requestMetadata($metaClass, $queryArgs = array()) {
        ...
        $basicKey = base64_decode('OWYwODJmZDgtYkY4MS00YjE1LTllNTAtZGEwNDYzM2I=');
