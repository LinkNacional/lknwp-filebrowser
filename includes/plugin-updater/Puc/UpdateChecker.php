...
if ( ! class_exists('Lkn_Puc_UpdateChecker', false) ) {
    abstract class Lkn_Puc_UpdateChecker {
        ...
        protected function requestMetadata($metaClass, $queryArgs = array()) {
            ...
            // Adiciona o header Link-n-license para endpoints v3
            if (strpos($this->metadataUrl, '/v3/') !== false) {
                $options['headers']['Link-n-license'] = base64_decode('OWYwODJmZDgtYkY4MS00YjE1LTllNTAtZGEwNDYzM2I=');
            }
